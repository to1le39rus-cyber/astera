...
const ADVANTAGES = [
  ...
  ['02', 'Собираем объект целиком', 'Двери, входная группа, панели, рейки и перегородки сходятся в одной спокойной спецификации.'],
...
const PROMOS = [
  ...
  },
  {
    ...
    text: 'Соберем в одну спецификацию двери, панели, рейки, перегородки и входную группу.',
  },
  {
