...
const SUPPORT = [
  ...
  ['тихо', 'условия без лишней публичности'],
];
      ...
      <div class="designer-hero">
        <div class="designer-hero__copy">
          ...
          <div class="studio-hero__actions">
            <a class="studio-btn studio-btn--light" href="${leadLink('Здравствуйте! Я дизайнер, хочу получить партнерские условия Astera.')}" target="_blank" rel="noopener noreferrer">Получить условия 20%</a>
            <a class="studio-btn studio-btn--ghost" href="#designer-form">Отправить проект ${ARR_SVG}</a>
          </div>
        </div>
