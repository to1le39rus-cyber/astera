...
const staticPages = [
  ...
  { route: 'developers', title: 'Застройщикам и комплектация объектов | Astera', description: 'Комплектация дверей, входных групп, панелей и перегородок для квартир, домов, апартаментов и объектов в Калининграде.', h1: 'Комплектация дверей для объектов', text: 'Astera помогает застройщикам и управляющим проектами собрать двери, входные группы, панели и перегородки в понятную спецификацию с расчетом, поставкой и монтажом.', service: 'Комплектация объектов дверями и интерьерными решениями' },
  { route: 'project', title: 'Расчет проекта Astera в Калининграде', description: 'Короткий бриф Astera для расчета межкомнатных дверей, входной двери, панелей, реек и перегородок под квартиру, дом, дизайн-проект или объект.', h1: 'Расчет проекта Astera', text: 'Передайте задачу Astera: тип объекта, количество проемов, нужные решения, стадию ремонта и контакт. Мы подготовим понятный первый расчет и подскажем следующий шаг.', service: 'Расчет дверей и интерьерных решений под проект' },
